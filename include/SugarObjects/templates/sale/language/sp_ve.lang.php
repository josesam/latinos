 ...
 ********************************************************************************/
 ...
 $mod_strings = array (
  ...
  'LBL_SEARCH_FORM_TITLE' => 'Buscar de Ventas',
  'LBL_VIEW_FORM_TITLE' => 'Vista de Ventas',
  'LBL_LIST_FORM_TITLE' => 'Listar Ventas',
  ...
  'LBL_ACCOUNT_ID'=>'ID de Cuenta',
   ...
   'LBL_CURRENCY_SYMBOL'=>'Símbolo moneda',
...
//END DON'T CONVERT
  ...
  'UPDATE_VERIFY_TXT' => 'Verifica que los valores en las ventas son números decimales válidos con sólo caracteres numéricos (0-9) y decimales(.)',
