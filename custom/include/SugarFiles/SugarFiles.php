...
////            }
	...
	function getFilesWidgetEditView($id, $module,$convertida, $asMetadata=false, $tpl='') {
		...
		$template = empty($tpl) ? "custom/include/SugarFiles/templates/EditView.html" : $tpl;
	...
	function getFilesWidgetDetailView($focus, $tpl='') {
		...
		$templateFile = empty($tpl) ? "custom/include/SugarFiles/templates/DetailView.html" : $tpl;
