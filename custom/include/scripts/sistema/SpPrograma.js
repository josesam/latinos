...
//            source: function(req, add){
//                //pass request to server
//                jQuery.getJSON("index.php?callback=?&module=ee_Programas&action=modulo&modulo=ee_Modulo", req, function(data) {
//                    //create array for response objects
//                    var suggestions1 = [];
//                    //process response
//                    jQuery.each(data, function(i, val){
//                    suggestions1.push(val.name);
//                });
//                //pass array to callback
//                add(suggestions1);
//            });
...
//            source: function(req, add){
//                //pass request to server
//                jQuery.getJSON("index.php?callback=?&module=ee_Programas&action=profesores&modulo=ee_Profesores&tipo=Instructor", req, function(data) {
//                    //create array for response objects
//                    var suggestions = [];
//                    //process response
//                    jQuery.each(data, function(i, val){
