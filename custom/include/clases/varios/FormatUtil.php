...
class FormatUtil {
	 ...
	 * @return DateTime
	 */
	public static function formatDateObj($value, $format='Y-m-d') {
		if (!$value)
			return '';
		if ($value instanceof DateTime)
			return $value->format($format);
	 ...
	 * @return mixed
	 */
	public static function safeUnserialize($value, $default = null, $format = 'json') {
		if (empty($value))
			return $default;
		...
		switch ($format) {
			...
			case 'json' : return json_decode($text);
	...
	public static function normalizeString($string) {
        ...
        /*
         * Devuelve una fecha separado cada uno de sus componentes
         * @param <string>  Fecha cargada desde el formulario en formato yy-mm-dd
         * @return <array>
         */
        public  function splitDate($str=""){
                $php_date=array();
