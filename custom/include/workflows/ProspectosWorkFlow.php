...
class ProspectoWorkFlow extends WorkFlowHandler{
    private $tipo="1";
    /*
    ...
    function procesaWorkFlow($parent_id,$bean_module,$transicion,$estado_actual,$origen,$is_new=true){
        ...
        $usuario=$current_user->user_name;
            // si nuevo
          // Ver Medio webform, email, phone call
          // estado new enquiry
          // Si medio en carga_excel.
          // estado event_registration
          // si medio es contacto_directo 
          // estado  
       // si no es nuevo     
