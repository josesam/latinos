...
class StateMachine implements StateMachineInterface
{
     ...
     * @{inheritDoc}
     */
    public function addState($state,$type = 'normal')
    {
    ...
    public function getTransition($name)
    {
        if (!isset($this->transitions[$name])) {
            throw new TransitionException('Unable to find a transition called '.$name);
        }
    ...
    public function getState($name)
    {
        if (!isset($this->states[$name])) {
            throw new StateException('Unable to find a state called '.$name);
        }
