 ...
 switch ($reportes){
      ...
      case 6:
       ...
       case 7:
           ...
           /*-------------------------------------------------------------------------------------------------*/
           case 9:
            if (file_exists(SP_PATHREPORTES.'ReporteMotivosReciliacionDesistimiento/ReporteMotivosReciliacionDesistimiento.php')){
                include(SP_PATHREPORTES.'ReporteMotivosReciliacionDesistimiento/ReporteMotivosReciliacionDesistimiento.php');
            }
            if(class_exists("ReporteMotivosReciliacionDesistimiento")){
                $form=$_REQUEST;
                $manejador=new ReporteMotivosReciliacionDesistimiento($_REQUEST);
                $verreporte=$_REQUEST['verreporte'];
                $exportarExcel=$_REQUEST['descargar'];
                        if(isset($verreporte)){
                          $manejador->mostrarData();
