...
class AccountsViewReagendar extends ViewDetail{
    
    
    function AccountsViewReagendar(){
        parent::ViewDetail();
    }
    function process() {
        $this->display();
    ...
    function display() {
        ...
        if (file_exists($path)){
            ...
            $valor=$prospectoWorkflow->procesaWorkFlow($parent_id, "Accounts", 'reagendar', $status,"manual",false);
            if ($valor)
